          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed font-light">
                [Εδώ θα προσθέσετε την ιστορία της εταιρείας σας. Μπορείτε να περιγράψετε πώς ξεκινήσατε, ποια ήταν η
                έμπνευσή σας και πώς εξελιχθήκατε στο χρόνο.]
              </p>
              <p className="text-gray-600 leading-relaxed font-light">
                [Προσθέστε περισσότερες λεπτομέρειες για τη φιλοσοφία σας, τις αξίες σας και το τι σας κάνει μοναδικούς
                στον χώρο της κοσμηματοποιίας.]
              </p>
              <Button
                variant="outline"
